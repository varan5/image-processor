...
const JpgCompressor = () => {
  ...
  const onSubmitImage = async () => {
    ...
    simplePostCall("https://image-processorr.herokuapp.com/api/compressor/jpg", data)
      .then(response => {
    ...
    <div>
      {
        !loader ? <div>
          ...
          <Input accept="image/jpeg" type="file" name="file" onChange={changeHandler} id="contained-button-file" multiple type="file" />
          <div>
            {isSelected ? (
              <div>
          ...
          <label htmlFor="contained-button-file">
            <Button variant="contained" component="span">
              {isSelected ? "Jpg Uploaded" : "Upload Jpg Image"}
            </Button>
          </label>
